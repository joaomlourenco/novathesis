...
situation that has remained the same up to the current days. It was with
this novelty in mind (and the realization of the research that it
entailed), that the company decided to publish this PhD Project, in a
tripartite consortium with FCT-NOVA and the Portuguese Foundation for
