...
\epigraph{
  This work is licensed under the \href{https://www.latex-project.org/lppl/lppl-1-3c/}{\LaTeX\ Project Public \index{License} v1.3c}.
...
\section{The \emph{NOVAthesis} \index{Template}}
...
\subsection{Using \index{Overleaf}}
...
\subsection{Using a \index{installation!Local \LaTeX\ Installation}}
...
First of all, start by installing \LaTeX\ in your computer.  There are two main distributions, \href{https://miktex.org}{\index{\MikTeX}}\ and \href{https://www.tug.org/texlive/}{\index{\TeXLive}}, and both of them are available for the~3 most popular Operating Systems: Linux, macOS and Windows.
...
\subsection{\index{Suggestions}, \index{Bugs} and \index{Feature Requests}} % (fold)
