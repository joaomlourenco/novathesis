...
\chapter{ThesisDIFCTNL \emph{User's Manual}}
...
The \texttt{novathesis-files} folder contains additional files and folders that complement the main \gls{novathesisclass}\ file.  These are:
...
% = Package options =
% ===================
\section{\gls{novathesisclass}\ Class Options} % (fold)
