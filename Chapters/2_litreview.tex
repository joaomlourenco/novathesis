...
applications. This kind of study normally has three stages: planning,
conduction and reporting.

The planning stage of a \gls{sms} is when the authors define the
research questions and decide on the search protocol. The research
