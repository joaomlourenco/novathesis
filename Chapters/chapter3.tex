...
\begin{figure}[htpb]
    \centering
    \includegraphics[clip, trim=2.1cm 6.5cm 2.5cm 5cm, width=\textwidth]{img/eea_emissions.pdf}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[clip, trim=2cm 19.5cm 8.5cm 3.6cm, width=.8\textwidth]{img/arrythmia.pdf}
...
\begin{figure}[htpb]
    ...
    \includegraphics[clip,% 
        ...
        width=0.8\textwidth]{img/development.pdf}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[clip,%
        trim=5cm 12.2cm 5cm 10cm,%
        width =.8\textwidth]{img/fst.pdf}
