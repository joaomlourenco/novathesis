...
During the course of my PhD, I attended a course in the Computer Science
Department of this Faculty called "Advanced Software Development". One
of the assignments of this course was to write a Systematic Mapping
Study (\gls{SMS}) on this topic. This article is included in this
document as an appendix (see~\ref{ap:tomDoas}), and should be more
than sufficient for detailing the literary scenario for active
\gls{DOAS} tomography. Passive \gls{DOAS} systems, such as the ones that
are frequently used in volcanology, are described in
Section~\ref{sub:passive_doas_tomography_for_volcanic_plume_studies}.


\subsection{Passive DOAS tomography for volcanic plume studies}%
\label{sub:passive_doas_tomography_for_volcanic_plume_studies}
