...
\begin{minipage}{\linewidth}
	The first main rule you must know is that \textbf{you must} use the UTF8 encoding in your text files. All text editors do this nowadays, either by default or as an option available in the ``Save As'' command.
\end{minipage}%
}
