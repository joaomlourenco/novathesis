...
\ntsetup{school=nova/itqb}    % The school id
...
\ntsetup{fontstyle=libertine}   % The font set to be used in the document
...
\ntsetup{chapstyle=gigantisch}  % The chapter style to be used
%                               %     [ bar, bianchi, bluebox, compact, default,
%                               %       elegant, ell, gigantisch, hansen, ist, lyhne, madsen,
...
\ntsetup{printtimestamp=true} % Print a timestamp (when PDF was generated) in the cover
%                               % DEFAULT: printtimestamp=true

\ntsetup{spine=no}          % Print the “book spine” at the end of the document?
