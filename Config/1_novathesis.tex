...
% \ntsetup{setabstractorder={en,pt,fr}}   % The order for abstracts for the main language
% \ntsetup{setabstractorder={pt={en,pt,fr}}}   % The order for abstracts for a specific language
%                               %     [ en, pt, fr, it, de, es —> valid languages
%                               %     ]
