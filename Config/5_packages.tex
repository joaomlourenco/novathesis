...
\ntaddperson{adviser}(m,m){The monitor name, A monitor, NOVA University Lisbon}
\adviserstring(m,1,m,en):={Monitor}
\adviserstring(m,1,f,en):={Monitor}
\adviserstring(m,2,m,en):={Monitors}
\adviserstring(m,2,f,en):={Monitors}
\adviserorder():={a,c,m}
