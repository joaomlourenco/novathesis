...
\definecolor{CelticsGreen}{RGB}{0,122,51}
\definecolor{CelticsGold}{RGB}{139,111,78}
\definecolor{HotPink}{RGB}{227,28,121}
\definecolor{Gold}{RGB}{255,215,0}

\newcommand{\needscite}{\textbf{\textcolor{HotPink}{>>CITE<<}}}
\newcommand{\needswork}[1]{\textbf{\textcolor{Gold}{>>{#1}<<}}}
...
%% Adding German after English and Portuguese abstracts
\abstractorder(en):={en,pt,de}
