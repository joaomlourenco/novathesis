...
\nttitle(main,en){A Very Long and Impressive\\\emph{Thesis Title} with a Forced Line Break}%
\nttitle(main,pt){Um Título de Tese Longo\\e com uma Mudança de Linha Forçada}%

%         You may use "\\" to force line breaks
\nttitle(sub,en){Some thoughts \emph{on the Life}, the Universe,\\and Everything Else}%
