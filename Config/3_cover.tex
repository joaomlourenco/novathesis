...
\ntdegreename*(en){International Neuroscience Doctoral Programme (INDP)}
...
\ntspecialization*(en){Neurosciences}
...
%-------------------------------------------------------------------
\ntauthorname(m){Dennis Goldschmidt}{Dennis Goldschmidt}

%-------------------------------------------------------------------
% AUTHOR previous degree
% SYNTAX: \ntauthordegree{degree}
%-------------------------------------------------------------------
\ntauthordegree(en){MSc in Neural Systems \& Computation, ETH/UZH Zurich}
...
%         You may use "\\" to force line breaks
% Advisers(s)
\ntaddperson{adviser}(a,f){Carlos Ribeiro, Ph.D., Principal Investigator, Champalimaud Foundation}
% Co-advisers(s)
