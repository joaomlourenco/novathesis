...
\verb!myuniv-myfac-defaults.clo!:
...
The NOVA~FCT cover (\verb!NOVAthesisFiles/Schools/nova/fct/nova-fct-defaults.clo!)
...
The IST cover
(\verb!NOVAthesisFiles/Schools/ulisboa/ist/ulisboa-ist-defaults.clo!)
