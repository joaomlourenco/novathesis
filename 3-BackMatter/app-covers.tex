...
\hline
\texttt{status} & \texttt{working}, \texttt{provisional}, \texttt{final} & (all) & Filter by doc status \\
...
\texttt{height/phd}, \texttt{height/msc} & \textit{dim} & — & Per-doctype height override \\
