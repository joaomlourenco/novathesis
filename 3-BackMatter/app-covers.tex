...
\begin{itemize}
  \item \latexinline{NOVAthesisFiles/StyFiles/nt-covers.sty} — the legacy
        implementation, retained for compatibility.
  \item \latexinline{NOVAthesisFiles/StyFiles/nt-covers.sty} — the modern
...
The NOVA~FCT cover (\latexinline{NOVAthesisFiles/Schools/nova/fct/nova-fct-defaults.clo})
