...
%%
Å%% BUGS and SUGGESTIONS: please submit an issue at the project web page
%%
...
%%           book={opt1=va1,opt2=val2,...}	- options for book class
...
\documentclass[
	...
	book={a4paper,11pt},
	biblatex={
		style=alphabetic,	% ALTERNATIVES: numeric, alphabetic, authoryear
