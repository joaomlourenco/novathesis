...
% Use double spacing (default is one-and-half spacing), which allows
%     for the Adviser to insert revision notes and comments.
% (*)\onehalfspacing
% \doublespacing
...
\ptabstractfile{resumo}		% Abstract in Portuguese
\enabstractfile{abstract}	% Abstract in English


% The Table of Contents is always printed. 
% The other lists may be commented and omitted.
\printlistoffigures	% The List of Figures. Comment to omit.
\printlistoftables 	% The List of Tables. Comment to omit.
\printlistoflistings	% The List of Code Listings. Comment to omit.
\printglossary		% The List if Abreviations / Glossary. Comment to omit.
