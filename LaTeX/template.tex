...
\documentclass[
  ...
  docstyle=elegant, % bianchi bluebox brotherton dash default elegant(*) ell ger 
                    % hansen jenor lyhne madsen pedersen veelo vz14 vz34 vz43
	lang=en,          % en(*), pt
  coverlang=pt,     % en, pt(*)
...
\adviser[m]{John Doe Male Adviser Name}{Associate Professor}{\newline Some University Somewhere}
