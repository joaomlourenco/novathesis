...
\options{/novathesis/docfrontmatter/.new list = {
  % covers,        % The cover page
...
\options{/novathesis/docmainmatter/.new list = {
  ...
  % backcover,        % Print the back cover, if any!
}}
