...
\documentclass[
  ...
  % school=nova/fcsh,     % nova/fct(*), nova/fcsh, nova/ims, ul/ist, ul/fc, ipl/isel
  % lang=en,              % en(*), fr, it, pt
  % % coverlang=en,         % defaults to main language
  % % copyrightlang=en,     % defaults to main language
  % fontstyle=garamond    % baskervaldx bookman charter ebgaramond fbb fourier garamond
  %                       % heuristica kpfonts(*) libertine mathpazo1 mathpazo2 newcent
  %                       % newpx newtx
  % chapstyle=default,    % bianchi bluebox brotherton dash default elegant(*) ell ger
  %                       % hansen ist jenor lyhne madsen pedersen veelo vz14 vz34 vz43
  % otherlistsat=back,   % front(*), back
  % secondcover=true,    % print a second cover page
  % aftercover=true,     % false=don't true=include the aftercover file (even if exists)
  % linkscolor=SteelBlue,   % darkblue, black (Set to 'black' for PRINTING)
  ...
  % trackmessage=true,    % PLEASE PLEASE PLEASE be honest and fair and leave this as true…
  ...
  %   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %   %%% uncomment for 'numeric' sorted by author's last name like citations
  %   backend=bibtex,     % use bibtex if possible
  %   style=numeric-comp, % numeric(*), alphabetic, authoryear, bwl-FU
  %   sortcites=true,     % If numeric, sort cites by crescent order
  %   sorting=nyt,        % none, nyt(*), ynt
  %   %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  %   %%% uncomment for 'alphanumeric-key' like citations
  %   % backend=bibtex,   % use bibtex if possible
