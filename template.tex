...
\documentclass[
  ...
  biblatex={            % Options for biblatex (see biblatex documentation)
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    %%% uncomment for 'apa' like citatio, a lot of determination and
      dedication,ns
, a lot of determination and dedication,   % backend=biber,    % must use biber as the backend (and not bibtex)
