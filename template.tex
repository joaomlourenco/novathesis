...
\ntsetup{chapstyle=nsst}   % The chapter style to be used
...
%   DON'T TOUCH HERE! Please open edit the appropriate
%   configuration file “Config/degree_name_???.tex”
\ifphddoc{% PhD program
  \input{degree_name_phd}%
}{\ifmscdoc{% MSc program
  \input{degree_name_msc}%
}{% Other program
  \input{degree_name_other}%
}}
...
\ntaddperson{committee}[a,m]{Name of the adviser present in defense, Associate Professor, University}
