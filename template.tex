...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[msc,pt,twoside,11pt,utf8,a4paper]{thesisdifctunl}
...
\adviser[1][f]{[Nome da orientadora]}
% \adviser[2][m]{[Nome do segundo orientador]}

% Co-supervisors (maximum of 9)
% use [f] for female and [m] for male
\coadviser[1][m]{[Nome do co-orientador 1]}
\coadviser[2][f]{[Nome da co-orientadora 2]}
% \coadviser[3][m]{[Nome do co-orientador 3]}

% Jury (maximum of 9 elements)
% President of the jury
% use [f] for female and [m] for male
\jury[1][m]{[Nome do presidente do júri]}
% First referee
% use [f] for female and [m] for male
\jury[2][f]{[Nome do primeiro arguente]}
% Second referee - comment if just one referee
% use [f] for female and [m] for male
\jury[3][m]{[Nome do segundo arguente]}
% Other members of the jury - include the supervisor in this list
% use [f] for female and [m] for male
\jury[4][f]{[Nome do primeiro vogal]}
\jury[5][m]{[Nome do segundo vogal]}
\jury[6][f]{[Nome do terceiro vogal]}
\jury[7][m]{[Nome do quarto vogal]}
% \jury[8][f]{[Nome do quinto vogal]}
% \jury[9][m]{[Nome do sexto vogal]}
