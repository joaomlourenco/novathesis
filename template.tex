...
\typeout{TIME after_begin_document=\the\pdfelapsedtime}%
...
\typeout{TIME after_print_covers=\the\pdfelapsedtime}%
\ntprint{frontmatter}     % The default order is listed below, but can be changed
\typeout{TIME after_print_frontmatter=\the\pdfelapsedtime}%
...
\typeout{TIME after_print_mainmatter=\the\pdfelapsedtime}%
%                         % at the School's “defaults.ldf” with
%                         % "\ntsetprintorder{list_of_items}", where “list_of_items”
...
\typeout{TIME after_print_backcover=\the\pdfelapsedtime}%
