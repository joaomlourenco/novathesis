...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\documentclass[en,prepmsc,twoside,12pt]{thesisdifctunl}
...
\graphicspath{{Logo/}{User/Figures/}} 
...
% Uncomment to use double spacing (default is one-and-half spacing).
% Nice for supervisor to inert revision notes and comments.
%\doublespacing
%%============================================================
