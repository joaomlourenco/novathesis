...
% \ntsetup{gnumberlist=false}   % Do not show the page numbers that appear after
%                               %     the entries in glossaries
...
%\ntaddindex[false]{tableofcontents} % Not includes the table within itself
%\ntaddindex[false][4]{tableofcontents} % Not includes the table within itself and specifies its depth up to 4 numbers
