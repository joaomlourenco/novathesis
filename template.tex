...
\typeout{TIME ntthesisfrontmatter=\the\pdfelapsedtime}
%%------------------------------------------------------------
\ntprint{covers}      % The cover page
\typeout{TIME covers=\the\pdfelapsedtime}
\ntprint{frontmatter}     % The default order is listed below, but can be changed 
\typeout{TIME frontmatter=\the\pdfelapsedtime}
...
%%------------------------------------------------------------
\ntthesismainmatters     % The main text — Arabic page numbering
\typeout{TIME ntthesismainmatter=\the\pdfelapsedtime}
%%------------------------------------------------------------
...
\typeout{TIME mainmatter=\the\pdfelapsedtime}
%                         % at the School's “defaults.ldf” with
%                         % "\ntsetprintorder{list_of_items}", where “list_of_items”
...
\typeout{TIME backcover=\the\pdfelapsedtime}
