...
% \ntsetup{fontstyle=garamond   % baskervaldx bookman charter ebgaramond fbb fourier garamond
...
% \ntsetup{biblatex={style=numeric-comp, sortcites=true, sorting=none}}
%% NUMBERED ORDER BY LAST NAME OF FIRST AUTHOR
% \ntsetup{biblatex={style=numeric-comp, sortcites=true, sorting=nyt}}
%% APLHA CITATION ORDER BY LAST NAME OF FIRST AUTHOR
% \ntsetup{biblatex={style=alphabetic, sortcites=true, sorting=nyt}}
%% APA-LIKE CITATION
% \ntsetup{biblatex={natbib=true, style=apa, maxcitenames=2}}
