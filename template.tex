...
%\ntaddindex[true]{tableofcontents} % Includes the table within itself
%\ntaddindex[true][4]{tableofcontents} % Includes the table within itself and specifies its depth up to 4 numbers
