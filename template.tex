...
\texprof{\benchmarktoc}
\texprof{\typeout{TIME process front cover=\the\pdfelapsedtime}}
%%------------------------------------------------------------
%% Print front matter
\texprof{\benchmarktic}
...
\ntprint{backmatter}      % The default order is listed below, but can be changed
\texprof{\benchmarktoc}
\texprof{\typeout{TIME process backmatter=\the\pdfelapsedtime}}
%%------------------------------------------------------------
