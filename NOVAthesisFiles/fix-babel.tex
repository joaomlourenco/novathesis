...
\addto\captionsportuguese{%
  ...
  \def\listoflistingscaption{Índice de Listagens}%
...
\addto\captionsenglish{%
  ...
  \def\listoflistingscaption{List of Listings}%
...
\addto\captionsfrench{%
  ...
  \def\listoflistingscaption{Listes de Code}%
...
\addto\captionsitalian{%
  ...
  \def\listoflistingscaption{Listatos}%
