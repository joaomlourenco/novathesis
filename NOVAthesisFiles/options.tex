...
\options{/novathesis/.new family
  ...
  , chapstyle/.new choice = {bianchi.ldf, bluebox.ldf, default.ldf, elegant.ldf,
                             ell.ldf, hansen.ldf, ist.ldf, lyhne.ldf, madsen.ldf,
                            pedersen.ldf, section.ldf, southall.ldf, veelo.ldf,
                            vz34.ldf, vz43.ldf}
