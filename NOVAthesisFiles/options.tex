...
\options{/novathesis/.new family
  ...
  , school/.new cmd = {         \typeout{NT school [#1]}%
                                % \@my@schooloption#1\@nil%
                                \@nt@schooloption@i#1\@nil%
                                % \optionsalso{/novathesis/univ=nova, /novathesis/schl=fct}%
    }
  % , school/.new choice = {  {nova/fct}, {nova/fct-new}, {nova/fcsh}, {nova/ims}, {nova/ensp},
  %                           {ul/ist}, {ul/fc},
  %                           {uminho/ee},
  %                           {iscte-iul/ista},
  %                           {ipl/isel}, {ips/ests},
...
\AtEndDocument{%
  ...
  \iftoggle{/novathesis/cdcover}{%
    \InputIfFileExists{%
        NOVAthesisFiles/Schools/\@nt@univ/\@nt@schl/cdcover.tex%
    }%
      {}%
