...
Título: \MakeTextUppercase{\thedoctitle(\option{/novathesis/mainlang},main)}\par
Ano de conclusão: \option{/novathesis/ulisboa/fmv/examdate/year}

Designação do curso: \thedegreename(\option{/novathesis/lang/cover})\par
...
\option{/novathesis/ulisboa/fmv/examdate/day} de
\option{/novathesis/ulisboa/fmv/examdate/month} de
\option{/novathesis/ulisboa/fmv/examdate/year}.\par
\vspace*{2ex}
