...
% Make a box with the date
	...
	\newcommand{\make@spine@box@date}{%
	  \savebox{\novathesis@spine@box@date}{\fontfamily%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Fix the cover font
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\renewcommand*{\coverprehook}{%
  \ifxetexorluatex
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Draw the cover page
\fontsize{10}{10}\selectfont\thespine[year]}%
...
% Make a box with the title
	...
	\newcommand{\make@spine@box@title}{%
	  \savebox{\novathesis@spine@box@title}{\fontfamily%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Fix the cover font
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\renewcommand*{\coverprehook}{%
  \ifxetexorluatex
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Draw the cover page
\fontsize{14}{14}\selectfont\thespine[title]}
	...
	%  \fi%
	  \ifdim\novathesis@spine@box@title@height > 0.70\novathesis@spinewidth%
		\savebox{\novathesis@spine@box@title}{%
		  \parbox{0.70\paperheight}{\fontfamily%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Fix the cover font
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\renewcommand*{\coverprehook}{%
  \ifxetexorluatex
...
\fontsize{14}{14}\selectfont\thespine[title]}%
	  ...
	  \ifdim\novathesis@spinewidth > 50mm%
		\savebox{\novathesis@spine@box@title}{%
		  \rotatebox[origin=c]{-90}{\parbox{50mm}{\fontfamily%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Fix the cover font
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\renewcommand*{\coverprehook}{%
  \ifxetexorluatex
...
% Make a box with the author
	...
	\newcommand{\make@spine@box@author}{%
	  \savebox{\novathesis@spine@box@author}{\fontfamily%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Fix the cover font
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\renewcommand*{\coverprehook}{%
  \ifxetexorluatex
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%% Draw the cover page
\fontsize{10}{10}\selectfont\thespine[author]}
