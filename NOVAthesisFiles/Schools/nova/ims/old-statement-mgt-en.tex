...
\bigskip
\theschool(en),
% Accessing /novathesis/examdate/month gives None, currently replaced by \GetDocDate
\PrintDateISO{\GetDocDate(exam,year)-\GetDocDate(exam,month)-\GetDocDate(exam,day)}\par
\vspace*{2cm}
\begin{tabular}{@{}c@{}}
\toprule
\thedocauthor(name)
