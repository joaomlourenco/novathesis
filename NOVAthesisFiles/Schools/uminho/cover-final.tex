...
\spine(title):={\thedoctitle(\@LANG@COVER,main,plain)}
  ...
  \node [anchor=north west, inner sep=0pt, xshift=0.5*\myspinewidth]
    at (current page.north) {
      \begin{tikzpicture}[remember picture, overlay, xshift=7.9cm]
        ...
        \node [anchor=north west, inner sep=0pt]
            at (0,-10.45)
              {\umfontb\bfseries\parbox{111mm}{\thedoctitle(\@LANG@COVER,main)}};
        \node [anchor=south west, inner sep=0pt]
            at (0,-28.7)
              {\umfontc
              \PrintDateISO[\theofstr(\@LANG@COVER)]
                           {\GetDocDate(submission,year)-\GetDocDate(submission,month)}};
      \end{tikzpicture}
    };
  % SPINE
