...
\color{\thethesiscover(\option{/novathesis/docdegree},1-1,textcolor)}
  ...
  \node [anchor=north west, inner sep=0pt]
    at (current page.north west) {
      \begin{tikzpicture}[]
          ...
          \filldraw [fill=\expanded{\thethesiscover(\option{/novathesis/docdegree},1-1,bgcolor)}] (0,0) rectangle (\stockwidth,-\stockheight);]
      \end{tikzpicture}
    };
  % RIGHT PAGE
  \node [anchor=north west, inner sep=0pt, xshift=0.5*\myspinewidth]
    at (current page.north) {
      \begin{tikzpicture}[remember picture, overlay, xshift=7.9cm]
        ...
        \node [anchor=north west, inner sep=0pt]
            at (0,-10.45)
              {\umfontb\bfseries\parbox{111mm}{\thedoctitle(\option{/novathesis/coverlang},main,cover)}};
  ...
  \node [anchor=north west, inner sep=0pt]
    at (current page.north west) {
      \begin{tikzpicture}[]
          ...
          %       {\includegraphics[width=\stockwidth,height=\stockheight,align=t]{cover0}};
          %       %{CAPA-Tese-Doutoramento-EA}};
          \filldraw [fill=\expanded{\thethesiscover(\option{/novathesis/docdegree},1-2,bgcolor)}] (0,0) rectangle (\stockwidth,-\stockheight);]
      \end{tikzpicture}
    };
\end{tikzpicture}
