...
\statementofintegritytextstr(pt):={%
  ...
  \indent Mais declaro que conheço e que respeitei o Código de Conduta Ética da \theuniversity(\option{/novathesis/lang/main}).
  }
...
\statementofintegritytextstr(en):={%
  ...
  \indent I further declare that I have fully acknowledged the Code of Ethical Conduct of the \theuniversity(\option{/novathesis/lang/main}).
}
...
\null%
\vfill%
\thestatementofintegritytextstr(\option{/novathesis/lang/main})\\[1.5cm]
\thesignatureline(\option{/novathesis/lang/main})
\vfill%
