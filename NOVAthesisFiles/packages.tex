...
\csdef{files_hook}{%
  ...
  \optionlistdo{/@nt/file/bib}{%
    \ntgetkeyval{##1}\@nt@key\@nt@bibfile%
    \IfSubStr{\@nt@bibfile}{/}{\def\@nt@bibfolder{}}{\def\@nt@bibfolder{Bibliography/}}%
    \addbibresource{\expanded{\@nt@bibfolder\@nt@bibfile}}%
  }%
  %--------------------------------
  % “hyperref” stuff
  \RequirePackage[%
