...
\ifoptionequal{/novathesis/spine/layout}{none}{}{%
  ...
  \begin{tikzpicture}[remember picture, overlay,yscale=-1,yshift=-10.75pt+\@tempdima]%
    ...
    \@for\myi:=\expanded{\thespine(order)}\do{%
      ...
      \datamatchtf{\@align}{spine}({box,\myi,align},{text,align}){}{%
...
\newcommand{\printspinebox}[2]{%
  ...
  \IfStrEq{#1}{logo}{%
    % IMAGE
    \def\@boxscale{1}%
    \ifthenelse{\@angle = 0 \OR \@angle = 180}
                      {\def\@logowidth{\thespine(box,logo,len2)}\def\@logoheight{\@thespinewidth}}
                      {\def\@logoheight{\thespine(box,logo,len2)}\def\@logowidth{\@thespinewidth}}%
