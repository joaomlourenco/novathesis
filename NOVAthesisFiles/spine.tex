...
\newcommand{\ntprintspine}[1][]{%
  ...
  % draw image
    ...
    % \ifdatadefinedlist{thesiscover}({\option{/novathesis/docdegree},spine,bgcolor},{spine,bgcolor}){%
    \ifdatadefined{thesiscover}(\option{/novathesis/docdegree},spine,bgcolor){%
    ...
    % \ifdatadefinedlist{thesiscover}({\option{/novathesis/docdegree},spine,framecolor},{spine,framecolor}){%
    \ifdatadefined{thesiscover}(\option{/novathesis/docdegree},spine,framecolor){%
      \node[inner sep=0, anchor=center,
            rectangle, minimum width=\novathesis@spinewidth, minimum height=\paperheight,
            draw=\expanded{\thethesiscover(\option{/novathesis/docdegree},spine,framecolor)},fill=none]
           at (current page.center)
              {};
    }{}%
    % print bg image IF DEFINED
    % \ifdatadefinedlist{thesiscover}({\option{/novathesis/docdegree},spine,image},{spine,image}){%
    \ifdatadefined{thesiscover}(\option{/novathesis/docdegree},spine,image){%
    ...
    \ifdatadefinedlist{spine}({logo,\option{/novathesis/docdegree}},{logo}){%
    % \ifdatadefined{spine}({logo,\option{/novathesis/docdegree}},{logo}){%
    ...
    \ifoptionvoid{/novathesis/degreeacr}{}{%
      \def\@node@fillcolor{none}%
      \ifdatadefined{spine}(box,color){\edef\@node@fillcolor{\thespine(box,color)}}{}%
      \ifdatadefined{spine}(box,degreeacr,color){\edef\@node@fillcolor{\thespine(box,degreeacr,color)}}{}%
