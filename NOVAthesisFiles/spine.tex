...
\ifdatadefined{doctitle}(\option{/novathesis/coverlang},sub){%
  \def@ult{spine}(title)={\thedoctitle(\option{/novathesis/coverlang},spine): \thedoctitle(\option{/novathesis/coverlang},sub)}
}{%
  \def@ult{spine}(title)={\thedoctitle(\option{/novathesis/coverlang},spine)}
}
% \typeout{SPINE=[\option{/novathesis/coverlang}][\thespine(title)]}
