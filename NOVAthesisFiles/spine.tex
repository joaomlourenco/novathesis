...
\spine(default,box,title,align):={\thespine(default,text,align)}
\spine(default,box,title,margin,left):={0pt}
\spine(default,box,title,margin,right):={0pt}

\spine(default,box,date,len):={2.0cm}
\spine(default,box,date,align):={\thespine(default,text,align)}
...
\@for\@myitem:={%
        ...
        {box,logo,align},{box,author,align},{box,title,align},{box,date,align},%
