...
\newcommand{\ntprintspine}{%
  ...
  % draw image
    ...
    \datamatchtf{\arg}{thesiscover}({\option{/novathesis/docdegree},spine,bgcolor},{spine,bgcolor}){%
    ...
    \datamatchtf{\arg}{thesiscover}({\option{/novathesis/docdegree},spine,framecolor},{spine,framecolor}){%
      \node[inner sep=0, anchor=center,
            rectangle, minimum width=\novathesis@spinewidth, minimum height=\paperheight,
            draw=\arg,fill=none]
           at (current page.center)
    ...
    \datamatchtf{\arg}{thesiscover}({\option{/novathesis/docdegree},spine,image},{spine,image}){%
    ...
    \ifdatadefinedor{\arg}{spine}({logo,\option{/novathesis/docdegree}},{logo}){%
      \node[inner sep=0, anchor=center, yshift=-\expanded{\thespine(box,logo,top)-0.5*\thespine(box,logo,len)}
           ...
           at (current page.north)
              {\ifdataequal{spine}(\arg,angle){0}{\setkeys{Gin}{height=\novathesis@boxwidth}}%
                                                 {\setkeys{Gin}{width=\novathesis@boxwidth}}%
