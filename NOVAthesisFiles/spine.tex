...
\newcommand{\printspinebox}[2]{%
  ...
  \IfStrEq{#1}{logo}{%
    % IMAGE
    \IfStrEq{\@item}{none}{}{%
      \setbox1=\hbox{\hspace*{-\thespine(box,logo,margin,sep)}}%
      \@for\myj:={\@item}\do{%
        \StrCut{\myj}{/}\@lfile\@langle%
        \@ifmtarg{\@langle}{\edef\@langle{\@angle}}{}%
        \edef\@logowidth{\thespine(box,logo,len2)}\edef\@logoheight{\@thespinewidth}%
        \setbox0=\hbox{\includegraphics[width=\@logowidth,angle=\number\numexpr\@langle-90\relax,origin=c]{\@lfile}}%
        \ifdim\dimexpr\ht0+\dp0\relax>\@logoheight\relax%
          \setbox0=\hbox{\includegraphics[height=\@logoheight,angle=\number\numexpr\@langle-90\relax,origin=c]{\@lfile}}%
        \fi%
        \setbox1=\hbox{\box1\hspace*{\thespine(box,logo,margin,sep)}\box0}%
      }%
      \ifdim\dimexpr\wd1\relax>\@logowidth\relax%
        \setbox1=\hbox{\resizebox{\@logowidth}{!}{\box1}}%
      \fi%
      \scalebox{\@scale}{\box1}%
    }%
  }{%
