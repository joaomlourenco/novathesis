...
\newlength{\@spinevar} % ratio for scaling the variable boxes
...
\@reverelist{\expanded{\thespine(logo)}}\@logoorder%
...
\newcommand{\printspinebox}[2]{%
  ...
  \IfStrEq{#1}{logo}{%
    ...
    \IfStrEq{\@item}{none}{}{%
      ...
      % \typeout{W=\@lwidth\space H=\the\@lheight\space S=\@lspace}\FILE
      \setbox1=\hbox{\hspace*{-\@lspace}}%
      \@for\myj:={\@item}\do{%
        \StrCut{\myj}{/}\@@lspace\@lfile%
        % \typeout{LS=\@@lspace\space F=\@lfile}\FILE
        \IfIsDim{\@@lspace}{}{\edef\@lfile{\@@lspace/\@lfile}\edef\@@lspace{0pt}}%
        \StrCut{\@lfile}{/}\@lfile\@langle%
        % \typeout{F=\@lfile\space A=\@langle}\FILE
        \StrCut{\@langle}{/}\@langle\@lscale%
        % \typeout{F=\@lfile\space A=\@langle\space S=\@lscale}\FILE
