...
\chapterfile{1_introduction}
\chapterfile{2_litreview}
\chapterfile{3_methods}
\chapterfile{4_discussion}
\chapterfile{5_conclusion}
...
\appendixfile{app1_slr}
\appendixfile{app2_fff}
\appendixfile{app3_tomosim}
