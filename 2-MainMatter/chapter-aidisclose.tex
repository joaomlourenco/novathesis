...
\section{Using the \texorpdfstring{\novathesis}{NOVAthesis} Standard AI Disclosure Statement}
...
A detailed breakdown of the \AIDpackageName\ taxonomy, including objectives, scope, and specific keys for each of the nine categories, is provided in \autoref{app:taxonomy}.
