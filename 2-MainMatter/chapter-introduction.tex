...
The \novathesis\ template provides an \emph{easy to use} environment for writing your thesis. Detailed instructions on how to set up the template using \Overleaf\ or a local \hologo{LaTeX} installation are provided in the \emph{User's Manual} (see \autoref{sec:getting_started_amnual}).
