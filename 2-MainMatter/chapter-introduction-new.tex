...
\begin{tcolorbox}[colback=green!8]
  If you are going to spend zillions of hours writing your thesis/dissertation using the \gls{novathesis} \hologo{LaTeX} template (or some other \hologo{LaTeX} template), be wise and spend a couple of hours learning how to use it properly by reading its manual.  And then, be even wiser, and spend a few more hours \href{https://github.com/joaomlourenco/novathesis/wiki\#learning-latex}{learning some \LaTeX}.  I am sure that the time you are investing now will pay itself countless times before you submit your thesis/dissertation.\\\parbox{\linewidth}{\raggedleft---~\emph{João Lourenço}}
\end{tcolorbox}
...
\begin{itemize}
  ...
  \item Process using you favorite \hologo{LaTeX} processor (\hologo{pdfLaTeX}, \hologo{XeLaTeX}\ or \hologo{XeLaTeX}).
\end{itemize}
...
\label{fig:overleaf}
\end{wrapfigure}
\mbox{}\Overleaf\ is a collaborative cloud-based LaTeX editor used for writing, editing and publishing scientific documents. Like “Google Docs”,  for \hologo{LaTeX} users. You can edit and compile your \hologo{LaTeX} source on the cloud, without installing software in your own computer, and, much like \emph{Google Docs}, you can share your document with others users and everybody can edit the same file at the same time (this may be dangerous).
...
Please notice that the version currently available in Overleaf (v7.10.2) may be outdates.  The current version is v\novathesisversion. If that is the case, you may upload the latest version to Overleaf following the points below:
\begin{enumerate}
...
\subsection{Using a Local \hologo{LaTeX} Installation Local}
...
Once you have \hologo{LaTeX} up and running, remember to install a good \hologo{LaTeX} text editor.  I recommend you to take a look at  \href{https://tex.stackexchange.com/questions/339/latex-editors-ides}{this post} in the \url{tex.stackexchange.com} site.  If you want a quick and dirty recommendation, try \href{https://www.texstudio.org/}{\ntindex{TeXStudio}}.
...
\subsection{Using Prism}
\label{sub:using_prism}

OpenAI has their own Web-based LaTeX editor, \href{https://prism.openai.com}{Prism}\footnote{\url{\href{https://prism.openai.com}{Prism}}}, similar to Overleaf in many aspects.  Although it misses some of the Overleaf funcitonalities, it does not have the compilation timeout that affects the NOVAthesis tempalte in Overleaf.  You can upload and compile the NOVAthesis project in \href{https://prism.openai.com}{Prism}.
