...
\end{flushleft}
    to the folder
\begin{flushleft}
\hspace*{0.5cm}“\verb!\DIRFONTSTYLES/Fonts!”.
\end{flushleft}
...
The main class file.
\\
\DIRNTFILES   & \Folder  & \accessForbiden &
...
novathesis.cls     & file    &
The main class file. It will include additional files from \texttt{\DIRNTFILES} folder and its sub-folders.
\\
template.tex      & file    &
...
The \texttt{\DIRNTFILES} folder contains additional files and folders that complement the main \gls{novathesisclass}\ file.  These are:
